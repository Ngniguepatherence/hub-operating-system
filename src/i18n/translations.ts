...
export const translations = {
  ...
  hr: {
    ...
    payrollManagement: { fr: 'Gestion de la Paie', en: 'Payroll Management' },
    payrollSubtitle: { fr: 'Calculez les salaires avec IGS et CNPS', en: 'Calculate salaries with IGS and CNPS' },
    calculate: { fr: 'Calculer', en: 'Calculate' },
    payrollCalculated: { fr: 'Paie calculée avec succès', en: 'Payroll calculated successfully' },
    payrollExported: { fr: 'Paie exportée avec succès', en: 'Payroll exported successfully' },
    totalGross: { fr: 'Total Brut', en: 'Total Gross' },
    totalNet: { fr: 'Total Net', en: 'Total Net' },
    totalIGS: { fr: 'Total IGS', en: 'Total IGS' },
    additionalPay: { fr: 'Primes et Heures Supplémentaires', en: 'Bonuses and Overtime' },
    bonus: { fr: 'Prime', en: 'Bonus' },
    overtime: { fr: 'Heures Sup', en: 'Overtime' },
    payrollDetails: { fr: 'Détails de la Paie', en: 'Payroll Details' },
    baseSalary: { fr: 'Salaire Base', en: 'Base Salary' },
    grossSalary: { fr: 'Salaire Brut', en: 'Gross Salary' },
    netSalary: { fr: 'Salaire Net', en: 'Net Salary' },
    igs: { fr: 'IGS', en: 'IGS' },
    cnps: { fr: 'CNPS', en: 'CNPS' },
    igsInfo: { fr: 'Impôt Général sur les Salaires (IGS)', en: 'General Salary Tax (IGS)' },
    igsDescription: { fr: 'L\'IGS est calculé selon les barèmes progressifs en vigueur au Cameroun.', en: 'IGS is calculated according to progressive brackets in Cameroon.' },
    fiscal: { fr: 'Fiscalité', en: 'Tax' },
  },

  // Tax Management
  tax: {
    management: { fr: 'Gestion Fiscale', en: 'Tax Management' },
    subtitle: { fr: 'Suivez vos déclarations et obligations fiscales', en: 'Track your tax declarations and obligations' },
    declarations: { fr: 'Déclarations', en: 'Declarations' },
    pendingDeclarations: { fr: 'Déclarations en attente', en: 'Pending Declarations' },
    amountDue: { fr: 'Montant à payer', en: 'Amount Due' },
    estimatedIGS: { fr: 'IGS Mensuel Estimé', en: 'Est. Monthly IGS' },
    estimatedCNPS: { fr: 'CNPS Mensuel Estimé', en: 'Est. Monthly CNPS' },
    upcomingDeadlines: { fr: 'Échéances à venir', en: 'Upcoming Deadlines' },
    ...
    markedAsPaid: { fr: 'Marqué comme payé', en: 'Marked as paid' },
    igsBrackets: { fr: 'Barèmes IGS', en: 'IGS Brackets' },
    igsBracketsDescription: { fr: 'Barèmes de l\'Impôt Général sur les Salaires applicables au Cameroun.', en: 'General Salary Tax brackets applicable in Cameroon.' },
  },

  // Profile
  profile: {
    title: { fr: 'Mon Profil', en: 'My Profile' },
    subtitle: { fr: 'Gérez vos informations personnelles', en: 'Manage your personal information' },
    info: { fr: 'Profil', en: 'Profile' },
    ...
    department: { fr: 'Département', en: 'Department' },
    position: { fr: 'Poste', en: 'Position' },
    joined: { fr: 'Membre depuis', en: 'Joined' },
    saved: { fr: 'Profil enregistré', en: 'Profile saved' },
    ...
    notificationPrefs: { fr: 'Préférences de notification', en: 'Notification Preferences' },
    emailNotifs: { fr: 'Notifications email', en: 'Email Notifications' },
    emailNotifsDesc: { fr: 'Recevoir des notifications par email', en: 'Receive notifications via email' },
    pushNotifs: { fr: 'Notifications push', en: 'Push Notifications' },
    pushNotifsDesc: { fr: 'Notifications dans le navigateur', en: 'Browser notifications' },
    smsNotifs: { fr: 'Notifications SMS', en: 'SMS Notifications' },
    smsNotifsDesc: { fr: 'Recevoir des alertes par SMS', en: 'Receive alerts via SMS' },
    recentActivity: { fr: 'Activité Récente', en: 'Recent Activity' },
    loginAction: { fr: 'Connexion réussie', en: 'Successful login' },
    settingsChanged: { fr: 'Paramètres modifiés', en: 'Settings changed' },
    documentUploaded: { fr: 'Document téléversé', en: 'Document uploaded' },
  },
